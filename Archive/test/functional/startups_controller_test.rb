...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { founder: @startup.founder, founder_email: @startup.founder_email, name: @startup.name }
    end
  ...
  test "should update startup" do
    put :update, id: @startup, startup: { founder: @startup.founder, founder_email: @startup.founder_email, name: @startup.name }
    assert_redirected_to startup_path(assigns(:startup))
  end
