  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved goal as @goal" do
        ...
        post :create, {:goal => { "title" => "invalid value" }}, valid_session
        assigns(:goal).should be_a_new(Goal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested goal" do
        ...
        Goal.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => goal.to_param, :goal => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the goal as @goal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Goal.any_instance.stub(:save).and_return(false)
        put :update, {:id => goal.to_param, :goal => { "title" => "invalid value" }}, valid_session
        assigns(:goal).should eq(goal)
      end
